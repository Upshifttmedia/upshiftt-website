  ...
  return (
    <section className="relative bg-[#111111] py-24 md:py-36 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        {/* Body */}
        <FadeIn delay={0.2} className="max-w-2xl mb-16">
        ...
        {/* Stats row */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-white/5 rounded-2xl overflow-hidden mb-16">
          {stats.map((stat, i) => (
            <FadeIn key={i} delay={0.1 * i}>
              <div className="bg-[#111111] px-8 py-10 flex flex-col gap-3">
                <span className="font-[family-name:var(--font-syne)] font-bold text-5xl md:text-6xl text-[#4DD9C0] leading-none">
                  {stat.value}
                </span>
                <span className="text-white/45 text-sm leading-snug max-w-[180px]">
                  {stat.label}
                </span>
              </div>
            </FadeIn>
        ...
        <FadeIn delay={0.2}>
          <div className="max-w-lg">
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-white/40 text-xs ml-1 font-[family-name:var(--font-syne)]">Google Review</span>
            </div>
            ...
            <div className="bg-white/[0.04] border border-white/8 rounded-2xl p-7">
              <p className="text-white/75 text-base leading-relaxed mb-6 italic">
                &ldquo;Called at 8pm on a Friday and someone picked up immediately.
                Had a quote by morning. Absolutely recommend.&rdquo;
              </p>
              <div className="flex items-center gap-3 border-t border-white/5 pt-5">
                <div className="w-8 h-8 rounded-full bg-[#4DD9C0]/15 flex items-center justify-center shrink-0">
                  <span className="text-[#4DD9C0] text-xs font-bold font-[family-name:var(--font-syne)]">M</span>
                </div>
                <div>
                  <p className="text-white font-[family-name:var(--font-syne)] font-semibold text-sm">Mike R.</p>
