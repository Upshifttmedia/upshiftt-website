...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu — rendered outside <header> so it covers the full viewport */}
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            initial={{ opacity: 0 }}
            ...
            style={{ position: "fixed", inset: 0, zIndex: 40, backgroundColor: "#0A0A0A" }}
            className="md:hidden flex flex-col items-center justify-center gap-8"
          >
            {[
              { label: "Services", href: "/services" },
              { label: "Pricing", href: "/pricing" },
